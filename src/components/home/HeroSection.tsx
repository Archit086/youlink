  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-0 right-0 top-[14%] z-50 flex flex-col items-center px-5 text-center">
        <h1 className="leading-[0.95] text-strong">
          <span
      ...
      >
        <p className="text-sm leading-relaxed text-strong/80">{brand.promise}</p>
      </div>
      ...
      >
        <p className="text-xs leading-relaxed text-strong/80 sm:text-sm">{brand.goal}</p>
        <Link
          to="/hire"
          className="rounded-full bg-[#e8702a] px-7 py-3 text-sm font-medium text-strong transition-all hover:scale-[1.03] hover:bg-[#d2611f] hover:shadow-lg hover:shadow-[#e8702a]/30 active:scale-95"
        >
          Start a project
        </Link>
      </div>
