  ...
  return (
    <div className={props.className}>
      <motion.div
        ...
        className="flex flex-col gap-6 bg-[#0C0C0C] pb-6"
      >
        {[0, 1].map((copy) => (
          <div key={copy} aria-hidden={copy === 1 || undefined} className="flex flex-col gap-6">
            {props.testimonials.map(({ text, image, name, role }, i) => (
              <div
                key={i}
                className="w-full rounded-3xl border border-[#D7E2EA]/15 bg-[#D7E2EA]/[0.03] p-10 text-[#D7E2EA] shadow-lg shadow-black/40"
              >
                ...
                <div className="mt-5 flex items-center gap-3">
                  {image ? (
                    ...
                    <span
                      ...
                      className={cn(
                        ...
                        "border border-white/30 bg-white/10 text-xs font-medium text-white",
                      )}
                    >
                      {initials(name)}
                    </span>
                  ...
                  <div className="flex flex-col">
                    <div className="font-medium leading-5 text-white">{name}</div>
